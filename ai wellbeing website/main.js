(function() {
    ...
    // Enhanced navigation
    window.navigate = function(section) { // Make navigate global
        // Hide all sections
    ...
    window.toggleScreenTimeTracking = function() { // Make toggleScreenTimeTracking global
    ...
    window.showActivityModal = function() { // Make showActivityModal global
        document.getElementById('activity-modal').style.display = 'block';
    };

    // Fix activity logging
    window.logActivity = function(event) { // Make logActivity global
    ...
    window.showExerciseModal = function() { // Make showExerciseModal global
        document.getElementById('exercise-modal').style.display = 'block';
    };

    // Fix exercise modal and start functionality
    window.startExercise = function(type) { // Make startExercise global
    ...
    // Utilities
    window.closeModal = function(modalId) { // Make closeModal global
